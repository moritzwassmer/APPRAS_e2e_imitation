...
class GlobalConfig:
    ...
    stuck_threshold = 200/action_repeat # Number of frames after which the creep controller starts triggering. Divided by # TODO Inertia param
    creep_duration = 40 / action_repeat # Number of frames we will creep forward # TODO Inertia param
