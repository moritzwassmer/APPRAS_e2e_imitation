...
class GlobalConfig:
    ...
    stuck_threshold = 100/action_repeat # Number of frames after which the creep controller starts triggering. Divided by
    creep_duration = 120 / action_repeat # Number of frames we will creep forward
