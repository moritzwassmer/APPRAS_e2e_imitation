...
#TODO clean default values
parser = argparse.ArgumentParser()
eval_folder = "C:\\Users\\morit\\OneDrive\\UNI\\Master\\WS22\\APP-RAS\\Programming\\Evaluations"
parser.add_argument('--xml', type=str, default=eval_folder+'\\routes\\sample_evaluations\\2_routes_2_weathers_t1_t3.xml', help='Routes file.')
parser.add_argument('--results', type=str, default=eval_folder+'./results/sample_evaluations', help='Folder with json files to be parsed')
parser.add_argument('--save_dir', type=str, default=eval_folder+'./results/sample_evaluations/parsed', help='Directory for saving csvs')
parser.add_argument('--town_maps', type=str, default=eval_folder+'./results/sample_evaluations/town_maps_xodr', help='Directory containing town map images')
